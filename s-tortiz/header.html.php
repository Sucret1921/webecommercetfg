...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md bg-dark sticky-top border-bottom" data-bs-theme="dark">
      <div class="container">
        <a class="navbar-brand d-md-none" href="#"> La tendenta </a>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
              <li class="nav-item"><a class="nav-link" href="#">
                  <strong> La tendeta </strong>
                </a></li>
              <li class="nav-item"><a class="nav-link active" href="index.php">Catalogo</a></li>
              <li class="nav-item"><a class="nav-link" href="#">Contacto</a></li>

              <li class="nav-item"><a class="nav-link" href="checkout.php"><span id="num_cart"
            ...
            <?php else: ?>
                <a href="login.php" class="btn btn-outline-light ms-3">Iniciar sesión</a>
            <?php endif; ?>
